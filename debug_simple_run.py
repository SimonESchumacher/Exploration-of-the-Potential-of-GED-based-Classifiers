...
if __name__ == "__main__":
    ...
    DATASET= Dataset(name="MUTAG", source="TUD", domain="Bioinformatics", ged_calculator=ged_calculator, use_node_labels="label", use_edge_labels="weight",use_node_attributes=None,load_now=False)
    DATASET.load()
