...
from graph_mixup.mixup_generation.submix.hyperparams import (
    SubMixMethodHPProvider,
)


class SubMixDataModuleProvider(AbstractDataModuleProvider):
    @override
    def _get_method_config(self) -> BaseConfig:
        method_hp_provider = SubMixMethodHPProvider(self.trial)
    ...
    def get_data_module(
        ...
        return RDBDataModule(
            ...
            method_name=PreBatchMixupName.SUBMIX,
