...
# to set the mode:
TESTING_MODE= "SINGLE" # "SINGLE" or "ALL", "MULTI", "SPEEDTEST", "SPEEDMULTI"
...
# DATASET
DATASET_NAME="KKI" if TESTING_MODE != "MULTI" else "MULTI"  # e.g. "MUTAG", "PTC_MR", "IMDB-MULTI", "PROTEINS", "NCI1", "NCI109", "DD", "COLLAB", "REDDIT-BINARY"
